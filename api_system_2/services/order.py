...
from api_system_2.repositories.orders import OrderRepository
from api_system_2.services.publisher import RabbitmqPublisher
...
class OrderService:
    ...
    def send_orders_to_queue(self, start_id):
        orders, last_id = self.__repo.list(start_id)
        for order in orders:
